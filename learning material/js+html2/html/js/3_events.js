...
function setup() {
    ...
    // function changeOpacityOfSection() {
    //     console.log(this);
    ...
    // function mouseIntroHandler() {
    //     // console.log("hello");
    //     // console.log();
    //     // // "this" is a browser entity that returns the element that the event listener is associated with
    //     this.style.background = "rgba(214,110,239,0.5)";
    //     // console.log(document.querySelector(`#${this.id} p`));
    //     // console.log(`#${this.id} p`);
    //     // // ${} returns the variable value to be used in a string


    //     let introPar = document.querySelector(`#${this.id} p`)
    //     introPar.style.background = `rgba(214, 110, 239 ,.75)`;
    //     introPar.classList.add("intro-section-p-active");
    // }
